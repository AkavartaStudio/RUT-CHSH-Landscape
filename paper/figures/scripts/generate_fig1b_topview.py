...
cbar.ax.text(2.8, 2.0, 'Classical bound', va='center', fontsize=8, color='red', weight='bold')
...
# Legend - positioned fully inside the blue region, with smaller star marker
handles, labels = ax.get_legend_handles_labels()
ax.legend(loc='lower right', fontsize=9, framealpha=0.95,
         markerscale=0.5, bbox_to_anchor=(0.98, 0.02))
